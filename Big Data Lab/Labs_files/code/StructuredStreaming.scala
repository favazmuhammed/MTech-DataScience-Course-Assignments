// Today, we do some real-time log analysis which is coming from web server.
// Structure streaming in sparks.
...
/** Find the moview with the most ratings*/
object StructuredStreaming {   // StructuredStreaming depends on dataset
  ...
  def main(args:Array[String])
  {
    ...
    // you can give output on text file also rather than console, database also you can give output
